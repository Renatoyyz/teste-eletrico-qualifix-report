...
class Ui_TelaExecucao(object):
    def setupUi(self, TelaExecucao):
        ...
        self.lbImgEsquerdo.setGeometry(QtCore.QRect(3, 128, 420, 600))
        ...
        self.lbImgDireito.setGeometry(QtCore.QRect(601, 128, 420, 600))
        self.lbImgDireito.setStyleSheet("background-color: rgb(171, 171, 171);")
        self.lbImgDireito.setObjectName("lbImgDireito")
        self.lbNomePrograma_Esquerdo = QtWidgets.QLabel(TelaExecucao)
        self.lbNomePrograma_Esquerdo.setGeometry(QtCore.QRect(10, 2, 410, 22))
        self.lbNomePrograma_Esquerdo.setObjectName("lbNomePrograma_Esquerdo")
        self.btFinalizar = QtWidgets.QPushButton(TelaExecucao)
        self.btFinalizar.setGeometry(QtCore.QRect(582, 730, 140, 40))
        font = QtGui.QFont()
        ...
        self.label.setGeometry(QtCore.QRect(3, 29, 71, 22))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(TelaExecucao)
        self.label_2.setGeometry(QtCore.QRect(3, 50, 71, 22))
        self.label_2.setObjectName("label_2")
        self.txAprovadoE = QtWidgets.QLineEdit(TelaExecucao)
        self.txAprovadoE.setGeometry(QtCore.QRect(81, 29, 70, 20))
        ...
        self.txReprovadoE.setGeometry(QtCore.QRect(80, 53, 70, 20))
        ...
        self.txRetrabalhoE.setGeometry(QtCore.QRect(80, 77, 70, 20))
        ...
        self.label_4.setGeometry(QtCore.QRect(3, 74, 71, 22))
        self.label_4.setObjectName("label_4")
        self.lbContinuIndicaE = QtWidgets.QLabel(TelaExecucao)
        self.lbContinuIndicaE.setGeometry(QtCore.QRect(290, 26, 90, 30))
        ...
        self.lbIsolaIndicaE.setGeometry(QtCore.QRect(290, 60, 90, 30))
        ...
        self.txRetrabalhoD.setGeometry(QtCore.QRect(682, 77, 70, 20))
        ...
        self.lbContinuIndicaD.setGeometry(QtCore.QRect(930, 26, 90, 30))
        ...
        self.lbDataHora.setGeometry(QtCore.QRect(428, 145, 170, 22))
        ...
        self.lbAvisos.setGeometry(QtCore.QRect(335, 101, 351, 22))
        self.lbAvisos.setObjectName("lbAvisos")
        self.btRetrabalharEsquerdo = QtWidgets.QPushButton(TelaExecucao)
        self.btRetrabalharEsquerdo.setGeometry(QtCore.QRect(-4, 730, 140, 40))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.btRetrabalharEsquerdo.setFont(font)
        self.btRetrabalharEsquerdo.setObjectName("btRetrabalharEsquerdo")
        self.btDescartarEsquerdo = QtWidgets.QPushButton(TelaExecucao)
        self.btDescartarEsquerdo.setGeometry(QtCore.QRect(128, 730, 130, 40))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.btDescartarEsquerdo.setFont(font)
        self.btDescartarEsquerdo.setObjectName("btDescartarEsquerdo")
        self.lbNomePrograma_Direito = QtWidgets.QLabel(TelaExecucao)
        self.lbNomePrograma_Direito.setGeometry(QtCore.QRect(600, 0, 410, 22))
        self.lbNomePrograma_Direito.setObjectName("lbNomePrograma_Direito")
        self.lbNomeRotina = QtWidgets.QLabel(TelaExecucao)
        self.lbNomeRotina.setGeometry(QtCore.QRect(384, 60, 218, 30))
        self.lbNomeRotina.setObjectName("lbNomeRotina")
        self.lbQtdPrducaoEsquerdo = QtWidgets.QLabel(TelaExecucao)
        self.lbQtdPrducaoEsquerdo.setGeometry(QtCore.QRect(157, 60, 120, 22))
        self.lbQtdPrducaoEsquerdo.setObjectName("lbQtdPrducaoEsquerdo")
        self.lbQtdPrducaoDireito = QtWidgets.QLabel(TelaExecucao)
        self.lbQtdPrducaoDireito.setGeometry(QtCore.QRect(770, 60, 150, 22))
        self.lbQtdPrducaoDireito.setObjectName("lbQtdPrducaoDireito")
        self.btRetrabalharDireito = QtWidgets.QPushButton(TelaExecucao)
        self.btRetrabalharDireito.setGeometry(QtCore.QRect(887, 730, 140, 40))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.btRetrabalharDireito.setFont(font)
        self.btRetrabalharDireito.setObjectName("btRetrabalharDireito")
        self.btDescartarDireito = QtWidgets.QPushButton(TelaExecucao)
        self.btDescartarDireito.setGeometry(QtCore.QRect(765, 730, 130, 40))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.btDescartarDireito.setFont(font)
        self.btDescartarDireito.setObjectName("btDescartarDireito")
    ...
    def retranslateUi(self, TelaExecucao):
        ...
        self.lbNomePrograma_Esquerdo.setText(_translate("TelaExecucao", "<html><head/><body><p align=\"center\">Nome do Programa</p></body></html>"))
        ...
        self.label.setText(_translate("TelaExecucao", "Aprovada"))
        self.label_2.setText(_translate("TelaExecucao", "Reprovada"))
        ...
        self.label_4.setText(_translate("TelaExecucao", "Retrabalho"))
        ...
        self.label_6.setText(_translate("TelaExecucao", "Aprovada"))
        self.txAprovadoD.setText(_translate("TelaExecucao", "0"))
        self.label_7.setText(_translate("TelaExecucao", "Retrabalho"))
        self.label_8.setText(_translate("TelaExecucao", "Reprovada"))
        ...
        self.lbAvisos.setText(_translate("TelaExecucao", "<html><head/><body><p align=\"center\">Avisos</p></body></html>"))
        self.btRetrabalharEsquerdo.setText(_translate("TelaExecucao", "RETRABALHAR"))
        self.btDescartarEsquerdo.setText(_translate("TelaExecucao", "DESCARTAR"))
        self.lbNomePrograma_Direito.setText(_translate("TelaExecucao", "<html><head/><body><p align=\"center\">Nome do Programa</p></body></html>"))
        self.lbNomeRotina.setText(_translate("TelaExecucao", "<html><head/><body><p align=\"center\">TextLabel</p></body></html>"))
        self.lbQtdPrducaoEsquerdo.setText(_translate("TelaExecucao", "XXXX de XXXX"))
        self.lbQtdPrducaoDireito.setText(_translate("TelaExecucao", "XXXX de XXXX"))
        self.btRetrabalharDireito.setText(_translate("TelaExecucao", "RETRABALHAR"))
        self.btDescartarDireito.setText(_translate("TelaExecucao", "DESCARTAR"))
